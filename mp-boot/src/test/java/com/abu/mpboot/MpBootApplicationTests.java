...
class MpBootApplicationTests {
    ...
    void name09() {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/user?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("kang123");
        ...
        TableFill gmtCreate = new TableFill("insert_time", FieldFill.INSERT);
